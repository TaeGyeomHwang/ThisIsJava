...
public class JLabelExam extends JFrame {
	...
	public JLabel getJLabel2() {
		if (jLabel2 == null) {
			...
			jLabel2.setIcon(new ImageIcon(getClass().getResource("../image3.jpg")));
	...
	public JLabel getJLabel3() {
		if (jLabel3 == null) {
			...
			jLabel3.setIcon(new ImageIcon(getClass().getResource("../image2.jpg")));
	...
	public JLabel getJLabel4() {
		if (jLabel4 == null) {
			...
			jLabel4.setIcon(new ImageIcon(getClass().getResource("../image1.jpg")));
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> {
			JLabelExam jFrame = new JLabelExam();
